...
const ASMRStaticBackground = () => {
  ...
  return (
    <div className="absolute inset-0 z-0 w-full h-full bg-[#0a0a0c] overflow-hidden cursor-none pointer-events-auto">
      <canvas
        ref={canvasRef}
      ...
      <div 
        className="fixed top-0 left-0 w-4 h-4 rounded-full border border-white/20 pointer-events-none transition-transform duration-75 ease-out z-50 mix-blend-difference"
        style={{
